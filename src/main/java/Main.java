...
//        converter.convert(action, pdfAbsolutePath);
        String pdfAbsolutePath = "C:\\Users\\Omer\\Omer\\University\\Year 3\\Semester 5\\Distributed\\Assignment1\\src\\main\\java\\small-input.txt";
        LocalApplication localApplication =  new LocalApplication();
        localApplication.run(pdfAbsolutePath ,10, true);
